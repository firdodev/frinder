              ...
              <div className='flex items-center justify-between p-4 bg-gray-50 dark:bg-gray-900 rounded-xl'>
                <div className='flex items-center gap-3'>
                  ...
                  <div>
                    ...
                    <p className='text-xs text-gray-500 dark:text-gray-400'>When you match with someone</p>
                  </div>
                </div>
                <Switch
              ...
              <div className='flex items-center justify-between p-4 bg-gray-50 dark:bg-gray-900 rounded-xl'>
                <div className='flex items-center gap-3'>
                  ...
                  <div>
                    ...
                    <p className='text-xs text-gray-500 dark:text-gray-400'>When you receive a new message</p>
                  </div>
                </div>
                <Switch
              ...
              <div className='flex items-center justify-between p-4 bg-gray-50 dark:bg-gray-900 rounded-xl'>
                <div className='flex items-center gap-3'>
                  ...
                  <div>
                    ...
                    <p className='text-xs text-gray-500 dark:text-gray-400'>When someone likes your profile</p>
                  </div>
                </div>
                <Switch
            ...
            <div className='flex items-center justify-between p-4 bg-gray-50 dark:bg-gray-900 rounded-xl'>
              <div className='flex items-center gap-3'>
                ...
                <div>
                  ...
                  <p className='text-xs text-gray-500 dark:text-gray-400'>Special offers and dating tips</p>
                </div>
              </div>
              <Switch
            ...
            <div className='space-y-3'>
              <div className='flex items-center gap-3 p-4 bg-gray-50 dark:bg-gray-900 rounded-xl'>
                ...
                <div>
                  ...
                  <p className='text-xs text-gray-500 dark:text-gray-400'>Enabled • Manage in device settings</p>
                </div>
              </div>
              ...
              <div className='flex items-center gap-3 p-4 bg-gray-50 dark:bg-gray-900 rounded-xl'>
                ...
                <div>
                  ...
                  <p className='text-xs text-gray-500 dark:text-gray-400'>Security alerts only</p>
                </div>
              </div>
            </div>
          </div>
